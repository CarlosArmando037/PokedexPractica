...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MVVM_implementacion_CARS_NEW.Android.dll" comes first in this list. */
		"MVVM_implementacion_CARS_NEW.Android.dll",
		"Firebase.dll",
		"FormsViewGroup.dll",
		"LiteDB.dll",
		"MVVM_implementacion_CARS_NEW.dll",
		"Newtonsoft.Json.dll",
		"System.Reactive.dll",
